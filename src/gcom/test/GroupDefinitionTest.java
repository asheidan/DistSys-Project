...
public class GroupDefinitionTest {
	...
	public void setUp() {
		...
		gdef_custom = new GroupDefinition("testGroup2",
				TYPE_COMMUNICATION.BASIC_RELIABLE_MULTICAST, TYPE_GROUP.STATIC,
	...
	public void testGetCommunicationType() {
		assertEquals(TYPE_COMMUNICATION.BASIC_UNRELIABLE_MULTICAST, gdef_simple
				.getCommunicationType());
		assertEquals(TYPE_COMMUNICATION.BASIC_RELIABLE_MULTICAST, gdef_custom
				.getCommunicationType());
	}
	...
	public void testGetMessageOrderingType() {
		assertEquals(TYPE_MESSAGEORDERING.NONORDERED, gdef_simple
				.getMessageOrderingType());
		assertEquals(TYPE_MESSAGEORDERING.FIFO, gdef_custom
				.getMessageOrderingType());
	}
